...
> 对照官方：[Service 基本功能](https://cloud.tencent.com/document/product/457/45489) · page_id `45489`
## 概述

通过 kubectl 创建和管理 Service 的基本操作：ClusterIP、NodePort、LoadBalancer 类型 Service 的全生命周期管理。
...
# expected: service/nginx-nodeport created
```

### 5. 数据面：创建 LoadBalancer Service
