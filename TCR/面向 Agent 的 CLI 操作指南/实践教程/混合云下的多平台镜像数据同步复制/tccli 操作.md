...
复制实例创建后，需将目标地域内需要拉取镜像的 VPC 接入该实例，实现就近内网拉取。详见[配置内网访问控制](../../操作指南/访问配置/访问网络控制/配置内网访问控制/tccli%20操作.md)。
...
配置自定义域名操作参见[配置自定义域名](../../操作指南/访问配置/访问域名配置/配置自定义域名/tccli%20操作.md)，涉及 SSL 证书上传（`tccli ssl UploadCertificate`）和 DNS CNAME 解析。
...
确认当前无已配置的同步规则。跨账号场景请同时参见[跨实例（账号）同步镜像](../../操作指南/镜像分发/跨实例（账号）同步镜像/tccli%20操作.md)。
...
若为 TCR 实例配置了自定义域名且不再需要，删除 SSL 证书绑定和 DNS CNAME 记录（参见[配置自定义域名](../../操作指南/访问配置/访问域名配置/配置自定义域名/tccli%20操作.md)）。
...
- [全球多地域间同步镜像实现就近访问](../全球多地域间同步镜像实现就近访问/tccli%20操作.md) -- 实例复制与同步实战
- [跨实例（账号）同步镜像](../../操作指南/镜像分发/跨实例（账号）同步镜像/tccli%20操作.md) -- 跨主账号同步规则详解
- [同实例多地域复制镜像](../../操作指南/镜像分发/同实例多地域复制镜像/tccli%20操作.md) -- 实例复制详细操作
- [配置内网访问控制](../../操作指南/访问配置/访问网络控制/配置内网访问控制/tccli%20操作.md) -- VPC 内网链路管理
- [配置自定义域名](../../操作指南/访问配置/访问域名配置/配置自定义域名/tccli%20操作.md) -- 统一域名管理
