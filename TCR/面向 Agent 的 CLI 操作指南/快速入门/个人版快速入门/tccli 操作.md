...
个人版与[企业版](../企业版快速入门/tccli%20操作.md)的核心区别：
...
- [企业版快速入门](../企业版快速入门/tccli%20操作.md) — 创建独立 TCR 实例并使用高级功能
- [更新登录密码](../../操作指南/个人版操作指南/更新登录密码/tccli%20操作.md) — 管理个人版全局密码
- [设置镜像清理](../../操作指南/个人版操作指南/设置镜像清理/tccli%20操作.md) — 镜像版本自动清理策略
