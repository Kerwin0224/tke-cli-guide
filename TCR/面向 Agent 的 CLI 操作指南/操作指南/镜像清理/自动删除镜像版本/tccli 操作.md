...
```bash
tccli tcr CreateTagRetentionRule --cli-input-json file://examples/tcr-retention-simple.json --region ap-guangzhou --output json
```
...
```bash
tccli tcr CreateTagRetentionRule --cli-input-json file://examples/tcr-retention-advanced.json --region ap-guangzhou --output json
```
...
```bash
tccli tcr ModifyTagRetentionRule --cli-input-json file://examples/tcr-retention-modify.json --region ap-guangzhou --output json
```
