...
- [环境准备](../../../../环境准备.md)
- 已 [购买企业版实例](../../创建企业版实例/tccli%20操作.md)，实例 `Status` 为 `Running`
...
- [管理镜像仓库](../../镜像创建/管理镜像仓库/tccli%20操作.md)（page_id `41811`） — 在同一命名空间管理容器镜像
- [管理命名空间](../../镜像创建/管理命名空间/tccli%20操作.md)（page_id `41803`） — 管理命名空间的公开/私有属性
- [OCI 制品管理概述](../OCI%20制品管理概述/tccli%20操作.md)（page_id `63918`） — 了解 TCR 支持的 OCI 制品类型
