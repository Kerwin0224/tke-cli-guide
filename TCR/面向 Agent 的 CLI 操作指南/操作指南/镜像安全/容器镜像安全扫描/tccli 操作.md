...
- 已 [创建命名空间](../../镜像创建/管理命名空间/tccli%20操作.md)
- 已 [创建镜像仓库并推送镜像](../../镜像创建/管理镜像仓库/tccli%20操作.md)（查询扫描结果的前置条件，非配置扫描策略的必要条件）
...
- [高危镜像部署阻断](../高危镜像部署阻断/tccli%20操作.md)（page_id `63869`） — 基于扫描结果阻断高危镜像部署（需 standard/premium）
- [镜像版本不可变](../镜像版本不可变/tccli%20操作.md)（page_id `58200`） — 锁定重要镜像版本防覆盖
- [管理镜像仓库](../../镜像创建/管理镜像仓库/tccli%20操作.md) — 推送镜像以触发安全扫描
- [创建企业版实例](../../创建企业版实例/tccli%20操作.md) — 升级实例规格以解锁部署阻断
