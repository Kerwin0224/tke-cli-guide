...
| 现象 | 原因 | 处理 |
|------|------|------|
| `InternalError` 或提示 "has not initialized user info" | 个人版尚未在控制台初始化 | 前往 [容器镜像服务控制台](https://console.cloud.tencent.com/tcr) 个人版实例卡片完成初始化。验证方式：`DescribeUserQuotaPersonal` 返回成功即已初始化（同[更新登录密码](../更新登录密码/tccli%20操作.md) 的限制） |
...
- [个人版快速入门](../../../快速入门/个人版快速入门/tccli%20操作.md)（page_id `63910`） — 推送/拉取镜像
- [企业版镜像版本保留](https://cloud.tencent.com/document/product/1141/50613) — 企业版 Tag 保留规则
- [更新登录密码](../更新登录密码/tccli%20操作.md)（page_id `63912`） — 管理个人版登录密码
